...
$display_query = "select event_id,event_name,event_start_date,event_end_date, venue from calendar_event_master";             
...
if($count>0) 
{
	...
	$data_arr[$i]['color'] = '#'.substr(uniqid('green'),-6); // 'green'; pass colour name
